...
(function() {
    ...
    var sampleDbPath = "./../audio/sample-db/", AudioContext = window.AudioContext || window.webkitAudioContext;
    AudioContext || (alert("Oh NO! Your Browser does not suppert AudioContext!?. We suggest Google Chrome to use this website. Maybe one day your browser will support new web technologies."), 
    ...
    Project.prototype.$ = function() {
        ...
        $("body").one("react-components-ready", function() {
            ...
            self.renderGUI(document.getElementById("content"), function() {
                ...
                self.project.open(initialProjectConfig, function() {
    ...
    /* ******************** GUI ************************************************************  */
    var GUI = function() {
        return this.initEventListeners(), this;
    };
    GUI.prototype.onPublishClick = function() {
        var username = "", password = "", user = new window.boom.User();
...
}, gui = new window.boom.GUI(studio);
