...
(function() {
    ...
    Device.prototype.spectrumCursorPosition = function(x) {
        ...
        var self = this;
        self._el ? (self.load(url, done), self.setLoadingProgressIndicator(!0)) : self.render(function() {
            self._el = this, self.setLoadingProgressIndicator(!0), self.load(url, done);
        });
    ...
    Project.prototype.$ = function() {
        ...
        var self = this;
        self.project = new self.Project(parentElement), self.project.studio = self, $("#gui-loading-progress").fadeOut("fast", function() {
        ...
        $("body").one("react-components-ready", function() {
            ...
            self.renderGUI(document.getElementById("content"), function() {
                initialProjectConfig ? (self.project.bpm = initialProjectConfig.bpm, self.project.open(initialProjectConfig, function() {
...
var studio = new window.boom.Studio(), projectConfig = {
    bpm: 80,
...
studio.init(projectConfig, function() {
    ...
    var Project = React.createClass({
        ...
        render: function() {
            ...
            }, React.createElement("div", null, React.createElement("strong", null, this.state.name), " - ", React.createElement("span", null, this.state.bpm)), devices);
        }
        ...
        render: function() {
            ...
            return React.createElement("div", {
                ...
                className: "device-transport-time"
            }, "PATTEN NAME"), React.createElement("div", {
