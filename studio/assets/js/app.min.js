...
b&&d.gui.alert("loading project"),d.renderGUI(document.getElementById("content"),function(){b?(d.project.bpm=b.bpm,d.project.name=b.name,d.project.open(b,function(e){a("#gui-loading-progress").fadeOut("fast",function(){e&&d.gui.alert("the song "+e.name+" is ready on "+e.bpm+" beats per minute!"),c&&a.proxy(c,d)(b)})})):a("#gui-loading-progress").fadeOut("fast",function(){c&&a.proxy(c,d)(b)})})};/* ******************** SLICE ************************************************************  */
