...
(function(){var a,b,c,d,e,f,g,h,i,j,k,l,m=this,n={}.hasOwnProperty,o=function(a,b){function c(){this.constructor=a}for(var d in b)n.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a},p=[].slice;k={},k.isEmpty=function(a){return 0===Object.keys(a).length},k.isArray=Array.isArray||function(a){return"[object Array]"===toString.call(a)},k.defaults=function(a,b){var c,d,e,f,g;for(f=Object.keys(b),g=[],d=0,e=f.length;e>d;d++)c=f[d],g.push(function(c){return null!=a[c]?a[c]:a[c]=b[c]}(c));return g},k.each=function(a,b){var c,d,e,f,g,h;if(a){for(k.isArray(a)&&a.forEach(b),c=[],g=Object.keys(a),h=[],e=0,f=g.length;f>e;e++)d=g[e],h.push(function(c){return b(a[c])}(d));return h}},k.pairs=function(a){var b,c,d,e,f,g;for(b=[],g=Object.keys(a),d=function(c){return b.push([c,a[c]])},e=0,f=g.length;f>e;e++)c=g[e],d(c);return b},k.map=function(a,b){var c,d,e,f,g,h;if(k.isArray(a))return a.map(b);for(c=[],h=Object.keys(a),e=function(d){return c.push(b(a[d]))},f=0,g=h.length;g>f;f++)d=h[f],e(d);return c},k.last=function(a,b){var c;return c=a.length,a.slice(c-b,c)},k.select=function(a,b){return a.filter(b)},k.extend=function(a,b){var c,d,e,f,g;for(g=Object.keys(b),d=function(c){return a[c]=b[c]},e=0,f=g.length;f>e;e++)c=g[e],d(c);return a},k.toArray=function(a){return Array.prototype.slice.call(a)},i=function(a,b,c,d,e){var f,g,h,i;return g=function(b){return a(function(a,d){var e,f,g,h;g=new c,g.dataType=b.dataType,"function"==typeof g.overrideMimeType&&g.overrideMimeType(b.mimeType),g.open(b.type,b.url),b.data&&"GET"!==b.type&&g.setRequestHeader("Content-Type",b.contentType),h=b.headers;for(e in h)f=h[e],g.setRequestHeader(e,f);return g.onreadystatechange=function(){var c,e;return 4===g.readyState?(null!=(e=b.statusCode)&&"function"==typeof e[c=g.status]&&e[c](),g.status>=200&&g.status<300||304===g.status?a(g):d(g)):void 0},g.send(b.data)})},i=function(b){return a(function(a){return a(b)})},h=function(b){return a(function(a,c){return c(b)})},f=function(){function c(c){var f,j,l,m,n,p,q,r,s,t,u,v,w,x,y,z,A,B,C;null==c&&(c={}),k.defaults(c,{rootURL:"https://api.github.com",useETags:!0,usePostInsteadOfPatch:!1}),A=this,B=[],l=function(){function a(a,b,c){this.eTag=a,this.data=b,this.status=c}return a}(),z={},w=function(a,b){return"function"==typeof a.notify?a.notify({type:"start",path:b}):void 0},v=function(a,b){return"function"==typeof a.notify?a.notify({type:"end",path:b}):void 0},C=function(b,f,h,i){var j,m,n,o;return null==i&&(i={raw:!1,isBase64:!1,isBoolean:!1}),"PATCH"===b&&c.usePostInsteadOfPatch&&(b="POST"),/^http/.test(f)||(f=""+c.rootURL+f),n=void 0,i.isBase64&&(n="text/plain; charset=x-user-defined"),m={Accept:"application/vnd.github.raw"},e&&(m["User-Agent"]=e),f in z?m["If-None-Match"]=z[f].eTag:m["If-Modified-Since"]="Thu, 01 Jan 1970 00:00:00 GMT",(c.token||c.username&&c.password)&&(j=c.token?"token "+c.token:"Basic "+d(""+c.username+":"+c.password),m.Authorization=j),o=a(function(a,d){var e,j,o,p,q=this;return e={url:f,type:b,contentType:"application/json",mimeType:n,headers:m,processData:!1,data:!i.raw&&h&&JSON.stringify(h)||h,dataType:i.raw?void 0:"json"},i.isBoolean&&(e.statusCode={204:function(){return a(!0)},404:function(){return a(!1)}}),p=g(e),j=function(a){var c,d,e,g,j,k;for(v(q,f),d=parseFloat(a.getResponseHeader("X-RateLimit-Limit")),e=parseFloat(a.getResponseHeader("X-RateLimit-Remaining")),k=[],g=0,j=B.length;j>g;g++)c=B[g],k.push(c(e,d,b,f,h,i));return k},p.then(function(d){var g,m,n,o,p,q,r,s;if(j(d),304===d.status)return c.useETags&&z[f]?(n=z[f],a(n.data,n.status,d)):a(d.responseText,status,d);if(204===d.status&&i.isBoolean)return a(!0,status,d);if(d.responseText&&"json"===e.dataType?(h=JSON.parse(d.responseText),q={},p=d.getResponseHeader("Link"),k.each(null!=p?p.split(","):void 0,function(a){var b,c,d,e;return e=a.match(/<([^>]+)>;\ rel="([^"]+)"/),b=e[0],c=e[1],d=e[2],q[""+d+"Page"]=function(){return C("GET",c,null,i)}}),k.extend(h,q)):h=d.responseText,"GET"===b&&i.isBase64){for(g="",o=r=0,s=h.length;s>=0?s>=r:r>=s;o=s>=0?++r:--r)g+=String.fromCharCode(255&h.charCodeAt(o));h=g}return"GET"===b&&d.getResponseHeader("ETag")&&c.useETags&&(m=d.getResponseHeader("ETag"),z[f]=new l(m,h,d.status)),a(h,d.status,d)}),o=function(b){var c,e;return j(b),i.isBoolean&&404===b.status?a(!1):"application/json; charset=utf-8"!==b.getResponseHeader("Content-Type")?(c=new Error(b.responseText),c.status=b.status,c.__jqXHR=b,d(c)):(c=new Error("Github error: "+b.responseText),e=b.responseText?JSON.parse(b.responseText):"",c.error=e,c.status=b.status,c.__jqXHR=b,d(c))},("function"==typeof p["catch"]?p["catch"](o):void 0)||p.fail(o)}),w(o,f),o},y=function(a){var b;return k.isEmpty(a)?"":(b=[],k.each(k.pairs(a),function(a){var c,d;return c=a[0],d=a[1],b.push(""+c+"="+encodeURIComponent(d))}),"?"+b.join("&"))},this.clearCache=t=function(){return z={}},this.getCache=u=function(){return z},this.setCache=x=function(a){if(null===a||"object"!=typeof a)throw new Error('BUG: argument of method "setCache" should be an object');return z=a},this.onRateLimitChanged=function(a){return B.push(a)},this.getZen=function(){return C("GET","/zen",null,{raw:!0})},this.getAllUsers=function(a){var b;return null==a&&(a=null),b={},a&&(b.since=a),C("GET","/users",b)},this.getOrgRepos=function(a,b){return null==b&&(b="all"),C("GET","/orgs/"+a+"/repos?type="+b+"&per_page=1000&sort=updated&direction=desc",null)},this.getPublicGists=function(a){var b,c;return null==a&&(a=null),c=null,b=function(a){return Date===a.constructor?a.toISOString():a},a&&(c={since:b(a)}),C("GET","/gists/public",c)},this.getPublicEvents=function(){return C("GET","/events",null)},this.getNotifications=function(a){var b,c;return null==a&&(a={}),b=function(a){return Date===a.constructor?a.toISOString():a},a.since&&(a.since=b(a.since)),c=y(a),C("GET","/notifications"+c,null)},s=function(){function a(a){var b,c;null==a&&(a=null),c=a?"/users/"+a:"/user",b=null,this.getInfo=function(a){return null==a&&(a=!1),a&&(b=null),b?i(b):C("GET",""+c,null).then(function(a){return b=a})},this.getRepos=function(a,b,d){return null==a&&(a="all"),null==b&&(b="pushed"),null==d&&(d="desc"),C("GET",""+c+"/repos?type="+a+"&per_page=1000&sort="+b+"&direction="+d,null)},this.getOrgs=function(){return C("GET",""+c+"/orgs",null)},this.getGists=function(){return C("GET",""+c+"/gists",null)},this.getFollowers=function(){return C("GET",""+c+"/followers",null)},this.getFollowing=function(){return C("GET",""+c+"/following",null)},this.isFollowing=function(a){return C("GET",""+c+"/following/"+a,null,{isBoolean:!0})},this.getPublicKeys=function(){return C("GET",""+c+"/keys",null)},this.getReceivedEvents=function(b){var c;if(!a)throw new Error("BUG: This does not work for authenticated users yet!");return c="",b&&(c="/public"),C("GET","/users/"+a+"/received_events"+c,null)},this.getEvents=function(b){var c;if(!a)throw new Error("BUG: This does not work for authenticated users yet!");return c="",b&&(c="/public"),C("GET","/users/"+a+"/events"+c,null)}}return a}(),f=function(a){function b(){b.__super__.constructor.call(this),this.updateInfo=function(a){return C("PATCH","/user",a)},this.getGists=function(){return C("GET","/gists",null)},this.follow=function(a){return C("PUT","/user/following/"+a,null)},this.unfollow=function(a){return C("DELETE","/user/following/"+a,null)},this.getEmails=function(){return C("GET","/user/emails",null)},this.addEmail=function(a){return k.isArray(a)||(a=[a]),C("POST","/user/emails",a)},this.addEmail=function(a){return k.isArray(a)||(a=[a]),C("DELETE","/user/emails",a)},this.getPublicKey=function(a){return C("GET","/user/keys/"+a,null)},this.addPublicKey=function(a,b){return C("POST","/user/keys",{title:a,key:b})},this.updatePublicKey=function(a,b){return C("PATCH","/user/keys/"+a,b)},this.createRepo=function(a,b){return null==b&&(b={}),b.name=a,C("POST","/user/repos",b)},this.getReceivedEvents=function(a,b){var c;return null==b&&(b=1),c="?page="+b,C("GET","/users/"+a+"/received_events"+c,null)},this.getStars=function(){return C("GET","/user/starred")},this.putStar=function(a,b){return C("PUT","/user/starred/"+a+"/"+b)},this.deleteStar=function(a,b){return C("DELETE","/user/starred/"+a+"/"+b)}}return o(b,a),b}(s),r=function(){function a(a){this.id=a,this.getInfo=function(){return C("GET","/teams/"+this.id,null)},this.updateTeam=function(a){return C("PATCH","/teams/"+this.id,a)},this.remove=function(){return C("DELETE","/teams/"+this.id)},this.getMembers=function(){return C("GET","/teams/"+this.id+"/members")},this.isMember=function(a){return C("GET","/teams/"+this.id+"/members/"+a,null,{isBoolean:!0})},this.addMember=function(a){return C("PUT","/teams/"+this.id+"/members/"+a)},this.removeMember=function(a){return C("DELETE","/teams/"+this.id+"/members/"+a)},this.getRepos=function(){return C("GET","/teams/"+this.id+"/repos")},this.addRepo=function(a,b){return C("PUT","/teams/"+this.id+"/repos/"+a+"/"+b)},this.removeRepo=function(a,b){return C("DELETE","/teams/"+this.id+"/repos/"+a+"/"+b)}}return a}(),p=function(){function a(a){this.name=a,this.getInfo=function(){return C("GET","/orgs/"+this.name,null)},this.updateInfo=function(a){return C("PATCH","/orgs/"+this.name,a)},this.getTeams=function(){return C("GET","/orgs/"+this.name+"/teams",null)},this.createTeam=function(a,b,c){var d;return null==b&&(b=null),null==c&&(c="pull"),d={name:a,permission:c},b&&(d.repo_names=b),C("POST","/orgs/"+this.name+"/teams",d)},this.getMembers=function(){return C("GET","/orgs/"+this.name+"/members",null)},this.isMember=function(a){return C("GET","/orgs/"+this.name+"/members/"+a,null,{isBoolean:!0})},this.removeMember=function(a){return C("DELETE","/orgs/"+this.name+"/members/"+a,null)},this.createRepo=function(a,b){return null==b&&(b={}),b.name=a,C("POST","/orgs/"+this.name+"/repos",b)},this.getRepos=function(){return C("GET","/orgs/"+this.name+"/repos?type=all",null)}}return a}(),n=function(){function a(a,b){var c;this.repoUser=a,this.repoName=b,c="/repos/"+this.repoUser+"/"+this.repoName,this.deleteRepo=function(){return C("DELETE",""+c)},this._updateTree=function(a){return this.getRef("heads/"+a)},this.getRef=function(a){return C("GET",""+c+"/git/refs/"+a,null).then(function(a){return a.object.sha})},this.createRef=function(a){return C("POST",""+c+"/git/refs",a)},this.deleteRef=function(a){return C("DELETE",""+c+"/git/refs/"+a,this.options)},this.getBranches=function(){return C("GET",""+c+"/git/refs/heads",null).then(function(a){return k.map(a,function(a){return k.last(a.ref.split("/"))})})},this.getBlob=function(a,b){return C("GET",""+c+"/git/blobs/"+a,null,{raw:!0,isBase64:b})},this.getSha=function(a,b){return""===b?this.getRef("heads/"+a):this.getTree(a,{recursive:!0}).then(function(a){var c;return c=k.select(a,function(a){return a.path===b})[0],(null!=c?c.sha:void 0)?null!=c?c.sha:void 0:h({message:"SHA_NOT_FOUND"})})},this.getContents=function(a,b){var d;return null==b&&(b=null),d="",null!==b&&(d=y({ref:b})),C("GET",""+c+"/contents/"+a+d,null,{raw:!0}).then(function(a){return a})},this.removeFile=function(a,b,d,e){var f;return f={message:b,sha:d,branch:e},C("DELETE",""+c+"/contents/"+a,f,null)},this.getTree=function(a,b){var d;return null==b&&(b=null),d=y(b),C("GET",""+c+"/git/trees/"+a+d,null).then(function(a){return a.tree})},this.postBlob=function(a,b){return"string"==typeof a&&(b&&(a=d(a)),a={content:a,encoding:"utf-8"}),b&&(a.encoding="base64"),C("POST",""+c+"/git/blobs",a).then(function(a){return a.sha})},this.updateTreeMany=function(a,b){var d;return d={base_tree:a,tree:b},C("POST",""+c+"/git/trees",d).then(function(a){return a.sha})},this.postTree=function(a){return C("POST",""+c+"/git/trees",{tree:a}).then(function(a){return a.sha})},this.commit=function(a,b,d){var e;return k.isArray(a)||(a=[a]),e={message:d,parents:a,tree:b},C("POST",""+c+"/git/commits",e).then(function(a){return a.sha})},this.updateHead=function(a,b,d){var e;return null==d&&(d=!1),e={sha:b},d&&(e.force=!0),C("PATCH",""+c+"/git/refs/heads/"+a,e)},this.getCommit=function(a){return C("GET",""+c+"/commits/"+a,null)},this.getCommits=function(a){var b,d;return null==a&&(a={}),a=k.extend({},a),b=function(a){return Date===a.constructor?a.toISOString():a},a.since&&(a.since=b(a.since)),a.until&&(a.until=b(a.until)),d=y(a),C("GET",""+c+"/commits"+d,null)}}return a}(),j=function(){function a(a,c){var d,e;e=a,d=c||function(){throw new Error("BUG: No way to fetch branch ref!")},this.getCommit=function(a){return e.getCommit(a)},this.getCommits=function(a){return null==a&&(a={}),a=k.extend({},a),d().then(function(b){return a.sha=b,e.getCommits(a)})},this.createBranch=function(a){return d().then(function(b){return e.getSha(b,"").then(function(b){return e.createRef({sha:b,ref:"refs/heads/"+a})})})},this.read=function(a,b){return d().then(function(c){return e.getSha(c,a).then(function(a){return e.getBlob(a,b).then(function(b){return{sha:a,content:b}})})})},this.contents=function(a){return d().then(function(b){return e.getSha(b,"").then(function(b){return e.getContents(a,b).then(function(a){return a})})})},this.remove=function(a,b,c){return null==b&&(b="Removed "+a),null==c&&(c=null),d().then(function(d){return c?e.removeFile(a,b,c,d):e.getSha(d,a).then(function(c){return e.removeFile(a,b,c,d)})})},this.move=function(a,b,c){return null==c&&(c="Moved "+a),d().then(function(d){return e._updateTree(d).then(function(f){return e.getTree(f,{recursive:!0}).then(function(g){return k.each(g,function(c){return c.path===a&&(c.path=b),"tree"===c.type?delete c.sha:void 0}),e.postTree(g).then(function(a){return e.commit(f,a,c).then(function(a){return e.updateHead(d,a).then(function(a){return a})})})})})})},this.write=function(a,b,c,d,e){var f;return null==c&&(c="Changed "+a),null==e&&(e=null),f={},f[a]={content:b,isBase64:d},this.writeMany(f,c,e)},this.writeMany=function(a,c,f){return null==c&&(c="Changed Multiple"),null==f&&(f=null),d().then(function(d){var g;return g=function(f){var g;return g=k.map(k.pairs(a),function(a){var b,c,d,f;return f=a[0],c=a[1],b=c.content||c,d=c.isBase64||!1,e.postBlob(b,d).then(function(a){return{path:f,mode:"100644",type:"blob",sha:a}})}),b(g).then(function(a){return e.updateTreeMany(f,a).then(function(a){return e.commit(f,a,c).then(function(a){return e.updateHead(d,a).then(function(a){return a.object})})})})},f?g(f):e._updateTree(d).then(g)})}}return a}(),q=function(){function a(a){var b,d;this.options=a,d=this.options.user,b=this.options.name,this.git=new n(d,b),this.repoPath="/repos/"+d+"/"+b,this.currentTree={branch:null,sha:null},this.updateInfo=function(a){return C("PATCH",this.repoPath,a)},this.getBranches=function(){return this.git.getBranches()},this.getBranch=function(a){var b;return null==a&&(a=null),a?(b=function(){return i(a)},new j(this.git,b)):this.getDefaultBranch()},this.getDefaultBranch=function(){var a,b=this;return a=function(){return b.getInfo().then(function(a){return a.default_branch})},new j(this.git,a)},this.setDefaultBranch=function(a){return this.updateInfo({name:b,default_branch:a})},this.getInfo=function(){return C("GET",this.repoPath,null)},this.getContents=function(a,b){return C("GET",""+this.repoPath+"/contents?ref="+a,{path:b})},this.fork=function(a){return a?C("POST",""+this.repoPath+"/forks",{organization:a}):C("POST",""+this.repoPath+"/forks",null)},this.createPullRequest=function(a){return C("POST",""+this.repoPath+"/pulls",a)},this.getCommits=function(a){return this.git.getCommits(a)},this.getEvents=function(){return C("GET",""+this.repoPath+"/events",null)},this.getIssueEvents=function(){return C("GET",""+this.repoPath+"/issues/events",null)},this.getNetworkEvents=function(){return C("GET","/networks/"+d+"/"+b+"/events",null)},this.getNotifications=function(a){var b,c;return null==a&&(a={}),b=function(a){return Date===a.constructor?a.toISOString():a},a.since&&(a.since=b(a.since)),c=y(a),C("GET",""+this.repoPath+"/notifications"+c,null)},this.getCollaborators=function(){return C("GET",""+this.repoPath+"/collaborators",null)},this.addCollaborator=function(a){if(!a)throw new Error("BUG: username is required");return C("PUT",""+this.repoPath+"/collaborators/"+a,null,{isBoolean:!0})},this.removeCollaborator=function(a){if(!a)throw new Error("BUG: username is required");return C("DELETE",""+this.repoPath+"/collaborators/"+a,null,{isBoolean:!0})},this.isCollaborator=function(a){if(null==a&&(a=null),!a)throw new Error("BUG: username is required");return C("GET",""+this.repoPath+"/collaborators/"+a,null,{isBoolean:!0})},this.canCollaborate=function(){var a=this;return c.password||c.token?A.getLogin().then(function(b){return b?a.isCollaborator(b):!1}).then(null,function(){return!1}):i(!1)},this.getHooks=function(){return C("GET",""+this.repoPath+"/hooks",null)},this.getHook=function(a){return C("GET",""+this.repoPath+"/hooks/"+a,null)},this.createHook=function(a,b,c,d){var e;return null==c&&(c=["push"]),null==d&&(d=!0),e={name:a,config:b,events:c,active:d},C("POST",""+this.repoPath+"/hooks",e)},this.editHook=function(a,b,c,d,e,f){var g;return null==b&&(b=null),null==c&&(c=null),null==d&&(d=null),null==e&&(e=null),null==f&&(f=null),g={},null!==b&&(g.config=b),null!==c&&(g.events=c),null!==d&&(g.add_events=d),null!==e&&(g.remove_events=e),null!==f&&(g.active=f),C("PATCH",""+this.repoPath+"/hooks/"+a,g)},this.testHook=function(a){return C("POST",""+this.repoPath+"/hooks/"+a+"/tests",null)},this.deleteHook=function(a){return C("DELETE",""+this.repoPath+"/hooks/"+a,null)},this.getLanguages=function(){return C("GET",""+this.repoPath+"/languages",null)},this.getReleases=function(){return C("GET",""+this.repoPath+"/releases",null)}}return a}(),m=function(){function a(a){var b,c;this.options=a,b=this.options.id,c="/gists/"+b,this.read=function(){return C("GET",c,null)},this.create=function(b,c,d){return null==c&&(c=!1),null==d&&(d=null),a={isPublic:c,files:b},null!=d&&(a.description=d),C("POST","/gists",a)},this["delete"]=function(){return C("DELETE",c,null)},this.fork=function(){return C("POST",""+c+"/forks",null)},this.update=function(b,d){return null==d&&(d=null),a={files:b},null!=d&&(a.description=d),C("PATCH",c,a)},this.star=function(){return C("PUT",""+c+"/star")},this.unstar=function(){return C("DELETE",""+c+"/star")},this.isStarred=function(){return C("GET",""+c,null,{isBoolean:!0})}}return a}(),this.getRepo=function(a,b){if(!a)throw new Error("BUG! user argument is required");if(!b)throw new Error("BUG! repo argument is required");return new q({user:a,name:b})},this.getOrg=function(a){return new p(a)},this.getUser=function(a){return null==a&&(a=null),a?new s(a):c.password||c.token?new f:null},this.getGist=function(a){return new m({id:a})},this.getLogin=function(){return c.password||c.token?(new s).getInfo().then(function(a){return a.login}):i(null)}}return c}()},"undefined"!=typeof exports&&null!==exports?(b=this.Promise||require("es6-promise").Promise,c=this.XMLHttpRequest||require("xmlhttprequest").XMLHttpRequest,j=function(a){return new b(a)},d=function(a){return b.all.call(b,a)},f=this.btoa||function(a){var b;return b=new Buffer(a,"binary"),b.toString("base64")},a=i(j,d,c,f,"octokit"),exports["new"]=function(b){return new a(b)}):(e=function(b,c){return null!=m.define?m.define("octokit",[],function(){return i(b,c,m.XMLHttpRequest,m.btoa)}):(a=i(b,c,m.XMLHttpRequest,m.btoa),m.Octokit=a,m.Github=a)},this.Q?(j=function(a){var b,c,d;return b=m.Q.defer(),d=function(a){return b.resolve(a)},c=function(a){return b.reject(a)},a(d,c),b.promise},d=function(a){return this.Q.all(a)},e(j,d)):this.angular?(h=angular.injector(["ng"]),h.invoke(function(a){return j=function(b){var c,d,e;return c=a.defer(),e=function(a){return c.resolve(a)},d=function(a){return c.reject(a)},b(e,d),c.promise},d=function(b){return a.all(b)},e(j,d)})):(null!=(l=this.jQuery)?l.Deferred:void 0)?(j=function(a){var b,c,d;return b=m.jQuery.Deferred(),d=function(a){return b.resolve(a)},c=function(a){return b.reject(a)},a(d,c),b.promise()},d=function(a){var b;return(b=m.jQuery).when.apply(b,a).then(function(){var a;return a=1<=arguments.length?p.call(arguments,0):[]})},e(j,d)):this.Promise?(j=function(a){return new m.Promise(function(b){return b.fulfill?a(b.resolve.bind(b),b.reject.bind(b)):a.apply(null,arguments)})},d=function(a){return m.Promise.all.call(m.Promise,a)},e(j,d)):(g=function(a){throw"undefined"!=typeof console&&null!==console&&"function"==typeof console.error&&console.error(a),new Error(a)})("A Promise API was not found. Supported libraries that have Promises are jQuery, angularjs, and https://github.com/jakearchibald/es6-promise"))}).call(this),function(){var a,b,c=function(a,b){return function(){return a.apply(b,arguments)}};window.Waveform=b=function(){function b(a){if(this.redraw=c(this.redraw,this),this.container=a.container,this.canvas=a.canvas,this.data=a.data||[],this.outerColor=a.outerColor||"transparent",this.innerColor=a.innerColor||"#000000",this.interpolate=!0,a.interpolate===!1&&(this.interpolate=!1),null==this.canvas){if(!this.container)throw"Either canvas or container option must be passed";this.canvas=this.createCanvas(this.container,a.width||this.container.clientWidth,a.height||this.container.clientHeight)}this.patchCanvasForIE(this.canvas),this.context=this.canvas.getContext("2d"),this.width=parseInt(this.context.canvas.width,10),this.height=parseInt(this.context.canvas.height,10),a.data&&this.update(a)}return b.name="Waveform",b.prototype.setData=function(a){return this.data=a},b.prototype.setDataInterpolated=function(a){return this.setData(this.interpolateArray(a,this.width))},b.prototype.setDataCropped=function(a){return this.setData(this.expandArray(a,this.width))},b.prototype.update=function(a){return null!=a.interpolate&&(this.interpolate=a.interpolate),this.interpolate===!1?this.setDataCropped(a.data):this.setDataInterpolated(a.data),this.redraw()},b.prototype.redraw=function(){var a,b,c,d,e,f,g,h;for(this.clear(),this.context.fillStyle="function"==typeof this.innerColor?this.innerColor():this.innerColor,c=this.height/2,b=0,g=this.data,h=[],e=0,f=g.length;f>e;e++)a=g[e],d=this.width/this.data.length,"function"==typeof this.innerColor&&(this.context.fillStyle=this.innerColor(b/this.width,a)),this.context.clearRect(d*b,c-c*a,d,c*a*2),this.context.fillRect(d*b,c-c*a,d,c*a*2),h.push(b++);return h},b.prototype.clear=function(){return this.context.fillStyle=this.outerColor,this.context.clearRect(0,0,this.width,this.height),this.context.fillRect(0,0,this.width,this.height)},b.prototype.patchCanvasForIE=function(a){var b;return"undefined"!=typeof window.G_vmlCanvasManager?(a=window.G_vmlCanvasManager.initElement(a),b=a.getContext,a.getContext=function(){var c;return c=b.apply(a,arguments),a.getContext=b,c}):void 0},b.prototype.createCanvas=function(a,b,c){var d;return d=document.createElement("canvas"),a.appendChild(d),d.width=b,d.height=c,d},b.prototype.expandArray=function(a,b,c){var d,e,f,g;if(null==c&&(c=0),e=[],a.length>b)e=a.slice(a.length-b,a.length);else for(d=f=0,g=b-1;g>=0?g>=f:f>=g;d=g>=0?++f:--f)e[d]=a[d]||c;return e},b.prototype.linearInterpolate=function(a,b,c){return a+(b-a)*c},b.prototype.interpolateArray=function(a,b){var c,d,e,f,g,h,i;for(g=new Array,h=new Number((a.length-1)/(b-1)),g[0]=a[0],f=1;b-1>f;)i=f*h,e=new Number(Math.floor(i)).toFixed(),c=new Number(Math.ceil(i)).toFixed(),d=i-e,g[f]=this.linearInterpolate(a[e],a[c],d),f++;return g[b-1]=a[a.length-1],g},b.prototype.optionsForSyncedStream=function(a){var b,c;return null==a&&(a={}),b=!1,c=this,{whileplaying:this.redraw,whileloading:function(){var d;return b||(d=this,c.innerColor=function(b){return b<d.position/d.durationEstimate?a.playedColor||"rgba(255,  102, 0, 0.8)":b<d.bytesLoaded/d.bytesTotal?a.loadedColor||"rgba(0, 0, 0, 0.8)":a.defaultColor||"rgba(0, 0, 0, 0.4)"},b=!0),this.redraw}}},b.prototype.dataFromSoundCloudTrack=function(b){var c=this;return a.get("http://www.waveformjs.org/w",{url:b.waveform_url},function(a){return c.update({data:a})})},b}(),a=function(){var a,b,c,d,e,f,g,h,i,j;return g=function(a){var b,c,d;return d=document.createElement("script"),b=!1,d.src=a,d.async=!0,d.onload=d.onreadystatechange=function(){return b||this.readyState&&"loaded"!==this.readyState&&"complete"!==this.readyState||(b=!0,d.onload=d.onreadystatechange=null,!d||!d.parentNode)?void 0:d.parentNode.removeChild(d)},c||(c=document.getElementsByTagName("head")[0]),c.appendChild(d)},c=function(a){return encodeURIComponent(a)},e=function(d,e,f,h){var i,k,l;k=-1===(d||"").indexOf("?")?"?":"&",h=h||a.callbackName||"callback",l=h+"_json"+ ++b,e=e||{};for(i in e)e.hasOwnProperty(i)&&(k+=c(i)+"="+c(e[i])+"&");return j[l]=function(a){f(a);try{delete j[l]}catch(b){}return j[l]=null},g(d+k+h+"="+l),l},i=function(a){var b;return b=a},b=0,d=void 0,h=void 0,f=void 0,j=this,a={},{get:e,init:i}}()}.call(this),function(a,b,c){function d(a,b){var c=b||0,d=Math.pow(10,c),e=Math.abs(Math.round(a*d)),f=(0>a?"-":"")+String(Math.floor(e/d));if(c>0){var g=String(e%d),h=new Array(Math.max(c-g.length,0)+1).join("0");f+="."+h+g}return f}var e,f="./../audio/sample-db/",g=window.AudioContext||window.webkitAudioContext;g?e=new g:(this.alert("Oh NO! Your Browser does not suppert AudioContext!?. Take a look at supported browser list to use this website. Maybe one day your browser will support new web technologies. o.O"),window.location="https://github.com/s-a/beatproducer#browser-support");var h=0,i=100,j=function(){return h++,h};a.ajaxTransport("+binary",function(a,b,c){
// check for conditions and support for blob / arraybuffer response type
// check for conditions and support for blob / arraybuffer response type
return window.FormData&&(a.dataType&&"binary"===a.dataType||a.data&&(window.ArrayBuffer&&a.data instanceof ArrayBuffer||window.Blob&&a.data instanceof Blob))?{
// create new XMLHttpRequest
send:function(b,c){
// setup all variables
var d=new XMLHttpRequest,e=a.url,f=a.type,g=a.async||!0,
// blob or arraybuffer. Default is blob
h=a.responseType||"blob",i=a.data||null,j=a.username||null,k=a.password||null;d.addEventListener("load",function(){var b={};b[a.dataType]=d.response,
// make callback and send data
c(d.status,d.statusText,b,d.getAllResponseHeaders())}),d.open(f,e,g,j,k);
// setup custom headers
for(var l in b)b.hasOwnProperty(l)&&d.setRequestHeader(l,b[l]);d.responseType=h,d.send(i)},abort:function(){c.abort()}}:void 0});var k=function(){return this.say=function(a,b){if(window.SpeechSynthesisUtterance&&window.speechSynthesis){var c=new SpeechSynthesisUtterance;
//msg.voice = voices[1]; // Note: some voices don't support altering params
c.voiceURI="native",c.volume=1,// 0 to 1
// msg.rate = 0; // 0.1 to 10
// msg.pitch = 1; //0 to 2
c.text=a,c.lang="en-US";var d=!1;c.onend=function(){d=!0,console.log("DONE!"),b&&b()},window.speechSynthesis.speak(c),window.setTimeout(function(){d||b&&b()},2e3)}else b&&b()},this},l=function(a){return this.device=a,this.effects=[],this.computedEffects=[],this.add({id:"MAINSIGNAL",type:"Compressor",
//connectTo : "MAIN",
config:{threshold:-18,knee:8}}),this};l.prototype.add=function(a){this.effects.push(a)},l.prototype.Effect=function(a,b){this.device=a;var c=null;if(b.source){for(var d=0;d<this.device.effectController.effects.length;d++){var e=this.device.effectController.effects[d];if(e.id===b.source){// eg main signal
c=this.device.effectController.computedEffects[d].output;// _comp
break}}if(!c)throw"Source Effect Device "+b.source+" not found"}var f=this.device.audioContext;if(!window.sa.webAudioFX[b.type])throw"Effect "+b.type+" not found!";return this.effect=new window.sa.webAudioFX[b.type](f,this.device.audioContext.destination,b.config),c&&c.connect(this.effect.output),"MAINSIGNAL"===b.id&&(this.device.destination=this.effect.output),this.effect},l.prototype.apply=function(){this.computedEffects=[];for(var a=0;a<this.effects.length;a++){var b=this.effects[a],c=new this.Effect(this.device,b);this.computedEffects.push(c)}};/* ******************** DEVICE ************************************************************  */
var m=function(b){b&&(this._el=b),this.effectController=new l(this),this._id=j(),this.audioContext=e,this.bufSrc=null,
...
this.transportTime=0,this._loadingProgressIndicatorInterval=null,this.markers=[],this._regions=[];var c=this;return a(window).resize(function(){c.onResize()}),this};m.prototype.addMarker=function(a){var b=function(a,b){return a-b};if(a){a=a.sort(b);for(var c=0;c<a.length;c++){var d=a[c],e=this.spectrumPosition({seconds:d});this.markers.push(e)}this.computeSpectrumPositions(),this.refreshSpectrum()}},m.prototype.onResize=function(){var a=this;window.clearTimeout(this.___to),this.___to=window.setTimeout(function(){a.computeSpectrumPositions(),a.initializeSpectrum()},400)},m.prototype.$=function(){var b=null;if(this._el)try{b=a(this._el.getDOMNode())}catch(c){b=a([])}else b=a([]);return b},m.prototype.get=function(b,c){var d=this;a.ajax({url:b,type:"GET",dataType:"binary",responseType:"arraybuffer",processData:!1,success:function(b){c&&a.proxy(c,d)(b)}})},m.prototype.load=function(b,d){var e=this,g=function(b){e.tape=new c.Tape(b),e.renderAudio(function(){e.setLoadingProgressIndicator(!1),e.initializeSpectrum(),d&&a.proxy(d,e)()})},h=function(a){e._el.setState({name:e.name}),e.audioContext.decodeAudioData(a,function(a){
//self.rawData = decodedData;
g(a)})};"string"==typeof b?(this.name||(this.name=b.split("/").pop()),this.filename||(this.filename=b.replace(f,"")),this.get(b,function(a){h(a)})):this.renderAudio(function(a){g(a)})},m.prototype.setLoadingProgressIndicator=function(a){if(a){this.$().find("canvas").remove();var c=this.$().find(".device-spectrum").get(0),d=[],e=new b({container:c,interpolate:!1}),f=e.context,g=f.createLinearGradient(0,0,0,e.height);g.addColorStop(0,"#f60"),g.addColorStop(1,"#ff1b00"),e.innerColor=g;var h=0;this._loadingProgressIndicatorInterval=setInterval(function(){h++,d.push(Math.cos(h/25)-.2+.3*Math.random()),e.update({data:d})},1)}else this.$().find("canvas").remove(),window.clearInterval(this._loadingProgressIndicatorInterval)},m.prototype.computeSpectrumPositions=function(){if(this.waveform)for(var b=a(this.waveform.container).width(),c=0;c<this.markers.length;c++){var d=this.markers[c];if(0!==d.percent&&!d.percent)throw"Need percantage value to compute slice positions in spectrum.";d.x=b/100*d.percent}},m.prototype.spectrumPosition=function(b){if(!this.audioBuffer)return null;var c=this.audioBuffer.duration,d={};if(b.x&&(d.x=b.x,d.percent=d.x/a(this.waveform.container).width()*100,d.seconds=d.percent/100*c),0===b.seconds&&(d.x=0,d.percent=0,d.seconds=0),b.seconds){var e=a(this.waveform.container).width();d.percent=b.seconds/c*100,d.x=e/100*d.percent,d.seconds=b.seconds}return d},m.prototype.refreshSpectrum=function(a){this.waveform&&(a||this.waveform.redraw(),this.refreshSpectrumMarkers(),this.spectrumPositionX&&n(this.waveform.context,this.spectrumPositionX,"#f60"))};var n=function(a,b,c){a.beginPath(),a.moveTo(b,0),a.lineTo(b,190),a.strokeStyle=c,a.stroke()};m.prototype.spectrumCursorPosition=function(a){this.spectrumPositionX=a,this.refreshSpectrum()},m.prototype.refreshSpectrumMarkers=function(){for(var a=0;a<this.markers.length;a++){var b=this.markers[a];n(this.waveform.context,b.x,"#fff"),n(this.waveform.context,b.x,"#fff")}},m.prototype.initializeSpectrum=function(){this.$().find("canvas").remove();var a=this.$().find(".device-spectrum").get(0);if(a&&this.audioBuffer){var c=this.audioBuffer.getChannelData(1);this.waveform=new b({container:a,interpolate:!0,innerColor:function(a){var b=this.device.audioBuffer.duration,c=this.device.transportTime/1e3,d=c/b;
//console.log(i,d);
//console.log(i,d);
return d>a?"#f60":"#676F98"}}),this.waveform.device=this,this.waveform.update({data:c});var d=this;d.refreshSpectrum(!0)}},m.prototype.renderAudio=function(b){var c=this;this.tape.render(this.audioContext,2).then(function(d){c.audioBuffer=d,b&&a.proxy(b,c)(d)})},m.prototype.onPlayBack=function(a){a||(this.transportTime+=i),this.refreshSpectrum();var b=0;this.transportTime>0&&(b=this.transportTime/1e3),this._el.setState({currentTime:d(b,1)})},m.prototype.play=function(b){if(/*
...
/*
			 ...
			 */
this.pause(),this.tape){var c=this;this.effectController.apply(),c.bufSrc=c.audioContext.createBufferSource(),c.bufSrc.buffer=c.audioBuffer,c.bufSrc.connect(c.destination),c.bufSrc.onended=function(){window.clearInterval(c.onPlayBackTimerInterval),b&&a.proxy(b,c)()};var d=a.proxy(c.onPlayBack,c);c.onPlayBackTimerInterval=window.setInterval(d,i),d();var e=0;this.transportTime>0&&(e=this.transportTime/1e3),c.bufSrc.start(0,e)}},m.prototype.stop=function(){var a=this;a.pause(),a.transportTime=0,a.onPlayBack(!0)},m.prototype.pause=function(){this.tape&&this.bufSrc&&(window.clearInterval(this.onPlayBackTimerInterval),this.bufSrc.stop())},m.prototype.open=function(b,c){var d=this;d._el?(d.load(b,function(){d.chopSlices(),c&&a.proxy(c,d)(d)}),d.setLoadingProgressIndicator(!0)):(d.parentElement||(d.parentElement=d.project._el.getDOMNode()),d.render(function(){d._el=this,d.setLoadingProgressIndicator(!0),d.load(b,function(){d.chopSlices(),c&&a.proxy(c,d)(d)})}))},m.prototype.slice=function(a){return this.slices(a)},m.prototype.chopSlices=function(){var a=function(a,b){return a.seconds-b.seconds},b=this;this.markers=this.markers.sort(a),this.slices=[];for(var c=0;c<this.markers.length-1;c++){var d=this.markers[c].seconds,e=this.markers[c+1].seconds-this.markers[c].seconds,f=this.tape.slice(d,e);this.slices.push(new s(b,f))}},m.prototype.config=function(){var a=this,b=function(){var b=[];if(a.markers)for(var c=0;c<a.markers.length;c++)b.push(a.markers[c].seconds);return b},c=function(){var b=[];if(a.patterns)for(var c=0;c<a.patterns.length;c++){var d=a.patterns[c];b.push({id:d.id,bars:d.bars,sequence:d.sequence})}return b};return{name:a.name,sample:this.filename,slices:b(),patterns:c()}};/* ******************** PROJECT ************************************************************  */
var o=function(a){return this.parentElement=a,this};o.prototype.$=function(){return a(this._el.getDOMNode())},o.prototype.reset=function(){this._el.setState({devices:[]})},o.prototype.newDevice=function(b,c){var d=this,e=new m,g=d._el.state.devices,h=function(){e.addMarker(b.slices),e.chopSlices(),c&&a.proxy(c,d)(e)};e.project=d,g.push(e),d._el.setState({devices:g},function(){if(b.sample){if(e.name=b.name,!e.name){var a=b.sample.split("/");a.length>1&&a.shift(),a=a.join("//"),e.name=a}e.filename=b.sample,e.open(f+b.sample,h)}e.patterns=[];for(var c=0;c<b.patterns.length;c++)e.patterns.push(new t(e,b.patterns[c]));b.tape&&(e.tape=b.tape,e.load(null,h))})},o.prototype.deviceContainer=function(a){return this.$().find(".project-device-container-"+a).get(0)},o.prototype.renderGUI=function(b){var c=this;c.render?c.render(function(){c._el=this,b&&a.proxy(b,c)()}):b()},o.prototype.open=function(a,b){var c=this;if(!a||!a.devices)return void b();c.all||(c.all=a.devices.length),c._el.setState({bpm:a.bpm,name:a.name});var d=function(){c.all--,0===c.all&&(c.all=null,b(a))};a.devices&&0!==a.devices.length||b();for(var e=0;e<a.devices.length;e++)c.newDevice(a.devices[e],d)},o.prototype.config=function(){for(var a={name:this.name,bpm:this.bpm,devices:[]},b=0;b<this._el.state.devices.length;b++){var c=this._el.state.devices[b].config();c.sample&&a.devices.push(c)}return a},o.prototype.configString=function(){return JSON.stringify(this.config(),"	",1)};/* ******************** SEQUENCER ************************************************************  */
var p=function(){return this};p.prototype.$=function(){return a(this._el.getDOMNode())},p.prototype.renderGUI=function(b){var c=this;c.render(function(){c._el=this,b&&a.proxy(b,c)()})};/* ******************** PATTERN-EDITOR ************************************************************  */
var q=function(){return this};q.prototype.$=function(){return a(this._el.getDOMNode())},q.prototype.renderGUI=function(b){var c=this;c.render?c.render(function(){c._el=this,b&&a.proxy(b,c)()}):b()},q.prototype.open=function(a){this._el.setState({connectedDevice:a,connectedDeviceName:a.name})};/* ******************** STUDIO ************************************************************  */
var r=function(){return this};o.prototype.$=function(){return a(this._el.getDOMNode())},r.prototype.Speech=k,r.prototype.Project=o,r.prototype.renderGUI=function(a,b){var c=this;c.project=new c.Project(a),c.project.studio=c,c.project.renderGUI(function(){c.patternEditor=new q,c.patternEditor.renderGUI(function(){
//$('#gui').fadeIn("slow", function(){
b()})})},r.prototype.reset=function(){this.project&&this.project.reset()},r.prototype.init=function(b,c){var d=this;d.reset(),
//var say = new this.Speech().say;
b&&(document.title=b.name),b&&d.gui.bpmSlider&&(d.gui.bpmSlider.value=b.bpm),a("#gui-loading-progress").fadeIn("fast",function(){}),
//$(function() {
//			$("body").one("react-components-ready", function() {
b&&d.gui.alert("loading project"),d.renderGUI(document.getElementById("content"),function(){b?(d.project.bpm=b.bpm,d.project.name=b.name,d.project.open(b,function(e){a("#gui-loading-progress").fadeOut("fast",function(){e&&d.gui.alert("&#8220;"+e.name+"&#8221; is ready with "+e.bpm+" beats per minute!"),c&&a.proxy(c,d)(b)})})):a("#gui-loading-progress").fadeOut("fast",function(){c&&a.proxy(c,d)(b)})})};/* ******************** SLICE ************************************************************  */
var s=function(a,b){
//var count = 1;
var d=1;return b=c.concat(b.split(1e3).map(function(a,b){var c=.1;return b>990&&(d-=c),a.gain(d)})),this.tape=b,this.audioContext=e,this.bufSrc=null,this.device=a,this.effectController=new l(this),this};s.prototype.play=function(b){this.effectController.effects=[];for(var c=0;c<this.device.effectController.effects.length;c++){var d=this.device.effectController.effects[c];this.effectController.add(d)}if(this.tape){var e=this;this.tape.render(this.audioContext,2).then(function(c){e.audioBuffer=c,e.effectController.apply(),e.bufSrc=e.audioContext.createBufferSource(),e.bufSrc.buffer=e.audioBuffer,e.bufSrc.connect(e.destination),e.bufSrc.onended=function(){b&&a.proxy(b,e)()},e.bufSrc.start(0,0)})}};/* ******************** PATTERN ************************************************************  */
var t=function(a,b){
//  7  this._chored = false;
//    this._db = {};
return this.device=a,this.id=b.id,this.bars=b.bars,this.sequence=b.sequence,this.patternConfig=b,this.audioContext=e,this.bufSrc=null,this.effectController=new l(this),this};t.prototype.toString=function(a){for(var b=this.sequence,c="",d=0;d<b.length;d++){var e=b[d];c+=-1===e.indexOf(a)?" ":"a"}return c},t.prototype.renderSequence=function(a){for(var b,d=this.device.project.bpm,e=1,f=6e4/d/1e3/(2*e),g=0;g<this.device.slices.length;g++){var h=this.device.slices[g].tape,i=new c.Sequence(this.toString(g+1),f,{a:h}).apply();b=b?b.mix(i):i}this.tape=b,a(b)},t.prototype.play=function(b){this.effectController.effects=[];for(var c=0;c<this.device.effectController.effects.length;c++){var d=this.device.effectController.effects[c];this.effectController.add(d)}var e=this;e.renderSequence(function(){e.tape.render(e.audioContext,2).then(function(c){e.audioBuffer=c,e.effectController.apply(),e.bufSrc=e.audioContext.createBufferSource(),e.bufSrc.buffer=e.audioBuffer,e.bufSrc.connect(e.destination),e.bufSrc.onended=function(){a.proxy(b,e)},e.bufSrc.loop=!0,e.bufSrc.start(0,0)})})},t.prototype.stop=function(){var a=this;a.pause(),a.transportTime=0},t.prototype.pause=function(){this.tape&&this.bufSrc&&this.bufSrc.stop()};/* ******************** USER ************************************************************  */
var u=function(){return this.mainRepoName="beatproducer-projects",this};u.prototype.login=function(a,b,c){this.github=new window.Octokit({username:a,password:b,auth:"basic"}),this.username=a,this.initialzeRepo(c)},u.prototype.forkRepo=function(a){var b=this;this.fork=this.github.getRepo(this.username,b.mainRepoName),this.repo=this.github.getRepo("s-a",b.mainRepoName);var c=function(c){401===c.status?b.onError(c):b.repo.fork().then(function(){window.setTimeout(function(){// give the fork some time
b.fork=b.github.getRepo(b.username,b.mainRepoName),a&&a()},5e3)},b.onError)};this.fork.getInfo().then(a,c)},u.prototype.initialzeRepo=function(a){this.forkRepo(a)},u.prototype.newSong=function(b,c){var d=this;a("#gui-loading-progress").fadeIn("fast",function(){d.branchname=b,d.branch=d.fork.getBranch("master"),d.branch.createBranch(b).then(function(){d.branch=d.fork.getBranch(b),c()},d.onError)})},u.prototype.saveSong=function(a,b,c){var d=this,e="projects/"+this.username+" "+this.branchname+".json";this.branch.write(e,a,b,!1).then(function(){window.gui.user=d,c&&c()},this.onError)},u.prototype.onError=function(b){var c=JSON.parse(b.message).errors;c?c=c[c.length-1]:(c=JSON.parse(b.message),c.resource="");var d=c.resource+"\n\n"+c.message;a("#gui-loading-progress").fadeOut("fast",function(){401===b.status&&window.gui.onLoginClick(),window.gui.alert(d)})},u.prototype.publish=function(b){var c=this,d={title:"I' d like to publish my new song. Yo!",body:"This pull request has been automatically generated by the beatproducer-GUI.",base:"master",head:this.username+":"+this.branchname};a("#gui-loading-progress").fadeIn("fast",function(){c.repo.createPullRequest(d).then(b,c.onError)})};/* ******************** GUI ************************************************************  */
var v=function(b){return g?(this.studio=b,this.credentials={uid:a.cookie("uid"),pwd:a.cookie("pwd")},a(".input-login-uid:first").val(this.credentials.uid),a(".input-login-pwd:first").val(this.credentials.pwd),this.initEventListeners()):(this.alert("Oh NO! Your Browser does not suppert AudioContext!?. Take a look at supported browser list to use this website. Maybe one day your browser will support new web technologies. o.O"),window.location="https://github.com/s-a/beatproducer#browser-support"),this};v.prototype.alert=function(b){var c=a('<paper-toast duration="5000" text="'+b+'"></paper-toast>');a("body").append(c),c.get(0).addEventListener("core-overlay-close-completed",function(){c.remove()}),c.get(0).show&&c.get(0).show()},v.prototype.onLoginClick=function(){document.querySelector("#login-dialog").toggle()},v.prototype.onSocialShareSongClick=function(){document.querySelector("#social-share-dialog").toggle(),window.setTimeout(function(){a(window).trigger("resize")},400)},v.prototype.onOpenProjectClick=function(){var b=window.gui;if(!(b.user||window.gui.credentials.uid&&window.gui.credentials.pwd))return void(new u).onError({status:401,message:'{"errors":[{"resource": "New Project","message":"No user login"}]}'});var c=function(a){for(var b=JSON.parse(a),c=[],d=0;d<b.length;d++){var e=b[d],f=e.name.split(" "),g=f.pop().split(".json")[0],h=f.join(" ");c.push({user:h,name:g})}return c},d=function(a,b){var c=a.github.getRepo("s-a","beatproducer-projects"),d=c.getBranch("master");d.contents("projects").then(b,a.onError)};a("#gui-loading-progress").fadeIn("fast",function(){});var e=new window.boom.User;e.login(window.gui.credentials.uid,window.gui.credentials.pwd,function(){d(e,function(b){var d=c(b),f=document.getElementById("public-project-list");f.model={projects:d};var g=e.github.getRepo(window.gui.credentials.uid,"beatproducer-projects");g.getBranches().then(function(b){for(var c=[],d=0;d<b.length;d++){var e=b[d].pop();"master"!==e&&c.push({name:e,user:window.gui.credentials.uid})}var f=document.getElementById("private-project-list");f.model={projects:c},a("#gui-loading-progress").fadeOut("fast",function(){document.querySelector("#project-open-dialog").toggle()})})})})},v.prototype.onSaveProjectClick=function(){if(!window.gui.credentials.uid||!window.gui.credentials.pwd)return void(new u).onError({status:401,message:'{"errors":[{"resource": "New Project","message":"No user login"}]}'});if(!window.gui.user)return void window.gui.onNewProjectClick();var b=window.gui.user.branchname;return""===b?void window.gui.onNewProjectClick():void a("#gui-loading-progress").fadeIn("fast",function(){var c=window.gui.user,d="Just improved my cool song. Boom!",e=window.gui.studio.project.configString();c.saveSong(e,d,function(){window.gui.user=c,a("#gui-loading-progress").fadeOut("fast",function(){window.gui.alert("Saved "+b)})})})},v.prototype.onMyWorkspaceClick=function(){return window.gui.credentials.uid&&window.gui.credentials.pwd?void window.open("https://github.com/"+window.gui.credentials.uid+"/beatproducer-projects"):void(new u).onError({status:401,message:'{"errors":[{"resource": "New Project","message":"No user login"}]}'})},v.prototype.onDiscussSongClick=function(){window.currentPublicProjectName?window.open("https://github.com/s-a/beatproducer-projects/issues/new?title="+window.currentPublicProjectName):window.gui.alert("You can only discuss published songs. Open a public song now and give your two cents!")},v.prototype.onNewProjectClick=function(){var b=a.trim(prompt("Please give your new masterpice a unique name.","new-song")).toLowerCase().replace(/ /g,"-");return window.gui.credentials.uid&&window.gui.credentials.pwd?void(""===b?window.gui.alert("Please enter a songname!"):a("#gui-loading-progress").fadeIn("fast",function(){var c=new window.boom.User;c.login(window.gui.credentials.uid,window.gui.credentials.pwd,function(){c.newSong(b,function(){var d="created a new song. yeah!",e=window.gui.studio.project.configString();c.saveSong(e,d,function(){window.gui.user=c,a("#gui-loading-progress").fadeOut("fast",function(){window.gui.alert("Created new song "+b)})})})})})):void(new u).onError({status:401,message:'{"errors":[{"resource": "New Project","message":"No user login"}]}'})},v.prototype.onNewSamplerClick=function(){var a=window.gui,b=a.studio.project._el.state.devices,c=new m;c.project=a.studio.project,b.push(c),a.studio.project._el.setState({devices:b})},v.prototype.onPublishClick=function(){var b=window.gui;if(b.user&&b.user.fork&&b.user.branch){/*var username = window.gui.credentials.uid;
...
c.saveSong(studio.project.configString(),"changed the song",function(){c.publish(function(){a("#gui-loading-progress").fadeOut("fast",function(){window.gui.alert("Pul request created. It may take a while until your request is processed.")})})})}else window.gui.alert("Create a new song or open a song from your personal workspace to publish.")},v.prototype.loginAction=function(){window.gui.credentials.uid=this.parentElement.querySelector(".input-login-uid").value,window.gui.credentials.pwd=this.parentElement.querySelector(".input-login-pwd").value;var b=a("#remember-login-password").get(0);b.checked&&(a.cookie("uid",window.gui.credentials.uid,{expires:365}),a.cookie("pwd",window.gui.credentials.pwd,{expires:365}))},v.prototype.initEventListeners=function(){var b=this;window.addEventListener("polymer-ready",function(){window.Polymer.addEventListener(document.getElementById("btn-login"),"tap",b.loginAction),b.bpmSlider=document.querySelector("#bpm"),b.bpmSlider.addEventListener("core-change",function(){b.studio.project&&(b.studio.project.bpm=b.bpmSlider.value)})}),document.addEventListener("DOMContentLoaded",function(){window.Polymer("x-foo",{});var b=function(b,c){var d=new window.boom.User;d.login(window.gui.credentials.uid,window.gui.credentials.pwd,function(){document.querySelector("#project-open-dialog").toggle(),a("#gui-loading-progress").fadeIn("fast",function(){var e=a(b),f=e.data("user"),g=e.data("name"),h=e.data("name"),i="projects/"+f+" "+g+".json",j=d.github.getRepo(c?"s-a":window.gui.credentials.uid,"beatproducer-projects"),k=j.getBranch(c?"master":h),l=!1;k.read(i,l).then(function(a){var b=JSON.parse(a.content);window.studio.init(b,function(){c?// need new created project on save
window.gui.user=null:(// can use current user an branch on save
window.gui.user=d,window.gui.user.branch=k,window.gui.user.branchname=h),window.currentPublicProjectName="Discussion about "+f+"'s "+g})},d.onError)})})};window.Polymer("x-open-public-project-link",{onOpenProjectButtonClick:function(a,c,d){b(d,!0)}}),window.Polymer("x-open-private-project-link",{onOpenProjectButtonClick:function(a,c,d){b(d,!1)}})}),a(function(){a("#studio-button-new-sampler").click(b.onNewSamplerClick),a("#studio-button-publish").click(b.onPublishClick),a("#studio-button-login").click(b.onLoginClick),a("#studio-button-new").click(b.onNewProjectClick),a("#studio-button-open").click(b.onOpenProjectClick),a("#studio-button-save").click(b.onSaveProjectClick),a("#studio-button-my-workspace").click(b.onMyWorkspaceClick),a("#studio-button-project-discuss").click(b.onDiscussSongClick),a("#studio-button-social-share-song").click(b.onSocialShareSongClick)})},/* ******************** PUBLIC ************************************************************  */
window.boom||(window.boom={Studio:r,Speech:k,Device:m,Slice:s,Project:o,PatternEditor:q,User:u,GUI:v})}(jQuery,window.Waveform,window.Ciseaux),/*
var defaultProject = {
	bpm : 080,
...
*/
window.studio=new window.boom.Studio,window.gui=new window.boom.GUI(window.studio),window.studio.gui=window.gui,$("body").on("react-components-ready",function(){window.studio.init(null,function(){
// load a  song?
var a=new window.LNK("b");a.raw.song?$.ajax({url:"https://api.github.com/repos/s-a/beatproducer-projects/contents/projects/"+a.raw.song+".json",method:"get",success:function(a){var b=window.atob(a.content);b=JSON.parse(b),window.studio.init(b,function(){})},error:function(b){window.gui.alert("Could not load song "+a.get("song")+": "+b.responseJSON.message)}}):window.boomTestSuite?window.boomTestSuite():$("#gui").get(0).responsiveWidth="1920px"})}),function(a,b,c,d,e){var f="./../audio/sample-db/",g=React.createClass({displayName:"Project",getInitialState:function(){return{devices:[],name:"new project",bpm:0}},render:function(){var a=this.state.devices.map(function(a,b){var c="project-device project-device-container-"+b;return React.createElement("div",{className:c},React.createElement(h,{device:a}))}.bind(this));return React.createElement("div",{className:"project-rack"},a)}}),h=React.createClass({displayName:"Device",handleOnDeleteDeviceClick:function(){for(var a=this.state.device.project._el.state.devices,b=this.state.device._id,c=0;c<a.length;c++){var d=a[c];if(d._id===b){a.splice(c,1);break}}var e=this.state.device.$();e.fadeOut("slow",function(){e.remove()})},handleOnRenameDeviceClick:function(){var b=a.trim(prompt("Please enter a name for this device",this.state.name)).toLowerCase().replace(/ /g,"-");if(""!==b){var c=this.state.device;c.name=b,this.setState({device:c,name:b})}},handleOnOpenPatternEditorClick:function(){a("#pattern-editor").slideDown("fast"),window.studio.patternEditor.open(this.state.device)},handleOnOpenClick:function(){this.state.device.open(f+"beatproducer-drum-loops-pack-1/bpnet_another-day-in-paradise_095bpm_4bars.wav",function(){})},handleOnPlayClick:function(){this.state.device.play()},handleOnPauseClick:function(){this.state.device.pause()},handleOnStopClick:function(){this.state.device.stop()},cursorPosition:function(b){var c=a(b.target),d=c.parent().offset(),e=b.pageX-d.left;return e},onSprectrumMouseLeave:function(){this.state.device.spectrumCursorPosition(null)},onSprectrumMouseMove:function(a){var b=this.cursorPosition(a);this.state.device.spectrumCursorPosition(b)},onSpectrumMouseClick:function(a){var b=this.state.device,c=b.spectrumPosition({x:this.cursorPosition(a)});c&&(b.markers.push(c),b.refreshSpectrum(),b.chopSlices(),b.project.studio.patternEditor.open(b))},getInitialState:function(){if(this.props.device){var a=this.props.device;a._el=this}return{device:a,name:"New Sampler",currentTime:0}},render:function(){return React.createElement("div",{key:this.state.device._id,className:"device-element-outset device"},React.createElement("strong",{onClick:this.handleOnRenameDeviceClick,className:"device-name"},this.state.device._id," ",this.state.name)," ",React.createElement("small",{className:"device-transport-time"},this.state.currentTime),React.createElement("div",null,React.createElement("div",{onClick:this.onSpectrumMouseClick,onMouseMove:this.onSprectrumMouseMove,onMouseLeave:this.onSprectrumMouseLeave,className:"device-spectrum device-element-inset"})),React.createElement("a",{className:"device-button device-button-play",href:"javascript:void(0);",onClick:this.handleOnPlayClick},React.createElement("img",{width:"32",src:"assets/images/ic_play_circle_fill_48px.svg",type:"image/svg+xml"})),React.createElement("a",{className:"device-button device-button-pause",href:"javascript:void(0);",onClick:this.handleOnPauseClick},React.createElement("img",{width:"32",src:"assets/images/ic_pause_circle_fill_48px.svg",type:"image/svg+xml"})),React.createElement("a",{className:"device-button device-button-stop",href:"javascript:void(0);",onClick:this.handleOnStopClick},React.createElement("img",{width:"32",src:"assets/images/ic_stop_48px.svg"})),React.createElement("a",{className:"device-button device-button-opensample",href:"javascript:void(0);",onClick:this.handleOnOpenClick},React.createElement("img",{width:"32",src:"assets/images/ic_folder_open_48px.svg"})),React.createElement("a",{className:"device-button device-button-pattern-editor",href:"javascript:void(0);",onClick:this.handleOnOpenPatternEditorClick},React.createElement("img",{width:"32",src:"assets/images/ic_queue_music_48px.svg"})),React.createElement("a",{className:"device-button device-button-pattern-editor",href:"javascript:void(0);",onClick:this.handleOnDeleteDeviceClick},React.createElement("img",{width:"32",src:"assets/images/ic_delete_48px.svg"})))}}),i=React.createClass({displayName:"PatternEditor",getInitialState:function(){if(this.props.patternEditor){var a=this.props.patternEditor;a._el=this}return{connectedDevice:null,patternEditor:a,connectedDeviceName:"[xNONE]"}},keyIsEquiped:function(a){return this.state&&this.state.connectedDevice&&this.state.connectedDevice.slices[a]?!0:!1},handleOnKeyClick:function(b){var c=parseInt(a(b.currentTarget).attr("data"));this.state.connectedDevice.slices[c].play()},handleOnPlayClick:function(){this.state.connectedDevice.patterns[0].play()},handleOnPauseClick:function(){this.state.connectedDevice.patterns[0].pause()},handleOnStopClick:function(){this.state.connectedDevice.patterns[0].stop()},handleOnStepClick:function(b){var c=a(b.target),d=parseInt(c.data("slice-index")),e=parseInt(c.data("step")),f=this.state.connectedDevice,g=f.patterns[0].sequence,h=g[e],i=h.indexOf(d);-1===i?h.push(d):h.splice(i,1),
//$el.toggleClass("pattern-keyboard-step-active");
this.setState({connectedDevice:f})},render:function(){for(var a=this,b=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],c=[].concat(b).concat(b).concat(b).concat(b).concat(b).concat(b).concat(b).concat(b),d=4,e=0,f=function(b){e++;var c=[],f="pattern-keyboard-key";if(-1!==b.indexOf("#")&&(f+=" pattern-keyboard-key-sharp"),"B"===b&&d--,a.keyIsEquiped(e-1)){c.push(React.createElement("div",{data:e-1,onClick:a.handleOnKeyClick,className:f},b,d)),-1!==b.indexOf("#")&&c.push(React.createElement("div",{onClick:a.handleOnKeyClick,className:"pattern-keyboard-step-offset"},React.createElement("div",{onClick:a.handleOnKeyClick,className:"pattern-keyboard-step-offset-top"}),React.createElement("div",{className:"pattern-keyboard-step-offset-bottom"})));var g=0;if(a.state&&a.state.connectedDevice){var h=a.state.connectedDevice.patterns[g];if(h)for(var i=0;i<h.bars;i++)for(var j=h.sequence.length,k=0;j>k;k++){var l="pattern-keyboard-step",m=h.sequence[k];-1!==m.indexOf(e)&&(l+=" pattern-keyboard-step-active"),c.push(React.createElement("div",{onClick:a.handleOnStepClick,"data-slice-index":e,"data-step":k,className:l},"X"))}}}return c},g=[],h=c.length-1;h>=0;h--){var i=c[h],j="pattern-row";-1!==i.indexOf("#")&&(j+=" pattern-row-sharp");var k=f(i);g.push(React.createElement("div",{className:j},React.createElement("div",{className:"pattern-keyboard"},k)))}return React.createElement("div",{className:"device-element-outset device"},React.createElement("a",{className:"device-button device-button-play",href:"javascript:void(0);",onClick:this.handleOnPlayClick},React.createElement("img",{width:"32",src:"assets/images/ic_play_circle_fill_48px.svg",type:"image/svg+xml"})),React.createElement("a",{className:"device-button device-button-stop",href:"javascript:void(0);",onClick:this.handleOnStopClick},React.createElement("img",{width:"32",src:"assets/images/ic_stop_48px.svg",type:"image/svg+xml"})),React.createElement("strong",{className:"device-name"},"PE")," - ",React.createElement("small",{className:"device-transport-time"},this.state.connectedDeviceName)," | ",React.createElement("small",{className:"device-transport-time"},"PATTERN NAME"),React.createElement("div",{className:"device-element-outset pattern-editor"},React.createElement("div",{className:"pattern"},g)))}});c.prototype.render=function(a){var b=this;React.render(React.createElement(h,null),b.parentElement,a)},d.prototype.render=function(a){var b=this;React.render(React.createElement(g,null),b.parentElement,a)},e.prototype.render=function(a){React.render(React.createElement(i,null),document.getElementById("pattern-editor"),a)},a("body").trigger("react-components-ready")}(window.jQuery,window.boom,window.boom.Device,window.boom.Project,window.boom.PatternEditor);
