...
var n=function(){return this};k.prototype.$=function(){return a(this._el.getDOMNode())},n.prototype.Speech=h,n.prototype.Project=k,n.prototype.renderGUI=function(a,b){var c=this;c.project=new c.Project(a),c.project.studio=c,c.project.renderGUI(function(){c.patternEditor=new m,c.patternEditor.renderGUI(function(){
//$('#gui').fadeIn("slow", function(){
b()})})},n.prototype.reset=function(){this.project&&this.project.reset()},n.prototype.init=function(b,c){var d=this;d.reset();(new this.Speech).say;b&&(document.title=b.name),b&&d.gui.bpmSlider&&(d.gui.bpmSlider.value=b.bpm),
//			window.addEventListener('polymer-ready', function (e) {
//			});
a("#gui-loading-progress").fadeIn("fast",function(){}),
//$(function() {
...
var o;f?o=new f:(this.alert("Oh NO! Your Browser does not suppert AudioContext!?. Take a look at supported browser list to use this website. Maybe one day your browser will support new web technologies. o.O"),window.location="https://github.com/s-a/beatproducer#browser-support");var p=function(a){var b=1;
//  7  this._chored = false;
//    this._db = {};
